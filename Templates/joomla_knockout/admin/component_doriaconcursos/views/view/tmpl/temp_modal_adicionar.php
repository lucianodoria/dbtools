...
<div class="modal fade" id="modalAdicionar" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" data-bind="with: $root.ModelEdicao()">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><span data-bind="text: $root.LabelModalAcao($root.ModelEdicao().acao)"></span> {TITLE}</h4>
            </div>
